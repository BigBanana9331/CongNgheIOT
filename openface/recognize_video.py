...
# python recognize_video.py --detector face_detection_model --embedding-model face_embedding_model/nn4.small2.v1.t7 --recognizer output/recognizer.pickle --le output/le.pickle
